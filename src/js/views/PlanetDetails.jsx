              ...
              <div className="card mb-3 bg-dark" style={{ width: "90%", height: "100%" }}>
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <h3 className="text-primary">{store.planetDetails.properties.name}</h3>
                    <p className="card-text text-primary fs-5">Terrain: {store.planetDetails.properties.terrain}</p>
                    <p className="card-text text-primary fs-5">Population: {store.planetDetails.properties.population}</p>
                    <p className="card-text text-primary fs-5">Climate: {store.planetDetails.properties.climate}</p>
                    <p className="card-text text-primary fs-5">Diameter: {store.planetDetails.properties.diameter}</p>
                    <p className="card-text text-primary fs-5">Days in 1 Year: {store.planetDetails.properties.orbital_period}</p>
                    <p className="card-text text-primary fs-5">Hours in 1 day: {store.planetDetails.properties.rotation_period}</p>
                    <p className="card-text text-primary fs-5">Gravity: {store.planetDetails.properties.gravity}</p>
                    <Link to="/">
